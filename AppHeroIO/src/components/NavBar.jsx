...
export default function NavBar() {
    return (
        <div className="navbar bg-base-100 shadow-sm ">
            <div className="max-w-[1400px] mx-auto flex items-center justify-between w-full px-4">
                ...
                <div className="navbar-end">
                    <div onClick={() => window.open("https://github.com/", "_blank", "noopener,noreferrer")} className="btn bg-gradient-to-r from-[#632EE3] to-[#9F62F2] text-white flex items-center gap-2">
